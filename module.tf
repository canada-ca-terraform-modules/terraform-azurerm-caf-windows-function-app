resource "azurerm_windows_function_app" "windows-function" {
  ...
  site_config {
    ...
    dynamic "application_stack" {
      for_each = if try(var.windows_function.site_config.application_stack, null) != null ? [1] : []
      content {
    ...
    dynamic "app_service_logs" {
      for_each = if try(var.windows_function.site_config.app_service_logs, null) != null : [1] : []
      content {
    ...
    dynamic "cors" {
      for_each = if try(var.windows_function.site_config.cors, null) != null : [1] : []
      content {
    ...
    dynamic "ip_restriction" {
      for_each = if try(var.windows_function.site_config.ip_restriction, null) != null : [1] : []
      content {
        ...
        dynamic "headers" {
          for_each = if try(ip_restriction.value.headers, null) != null : [1] : []
          content {
    ...
    dynamic "scm_ip_restriction" {
      for_each = if try(var.windows_function.site_config.scm_ip_restriction, null) != null : [1] : []
      content {
        ...
        dynamic "headers" {
          for_each = if try(scm_ip_restriction.value.headers, null) != null : [1] : []
          content {
            x_azure_fdid      = try(headers.value.x_azure_fdid, null)
            x_fd_health_probe = try(headers.value.x_fd_health_probe, null)
            x_forwarded_for   = try(headers.value.x_forwarded_for, null)
  ...
  dynamic "auth_settings" {
    for_each = if try(var.windows_function.auth_settings, null) != null : [1] : []
    content {
      ...
      dynamic "active_directory" {
        for_each = if try(auth_settings.value.active_directory, null) != null : [1] : []
        content {
      ...
      dynamic "facebook" {
        for_each = if try(auth_settings.value.facebook, null) != null : [1] : []
        content {
      ...
      dynamic "github" {
        for_each = if try(auth_settings.value.github, null) != null : [1] : []
        content {
      ...
      dynamic "google" {
        for_each = if try(auth_settings.value.google, null) != null : [1] : []
        content {
      ...
      dynamic "microsoft" {
        for_each = if try(auth_settings.value.microsoft, null) != null : [1] : []
        content {
      ...
      dynamic "twitter" {
        for_each = if try(auth_settings.value.twitter, null) != null : [1] : []
        content {
  ...
  dynamic "auth_settings_v2" {
    ...
    content {
      ...
      dynamic "apple_v2" {
        for_each = if try(auth_settings_v2.value.apple_v2, null) != null : [1] : []
        content {
      ...
      dynamic "active_directory_v2" {
        for_each = if try(auth_settings_v2.value.active_directory_v2, null) != null : [1] : []
        content {
      ...
      dynamic "azure_static_web_app_v2" {
        for_each = if try(auth_settings_v2.value.azure_static_web_app_v2, null) != null : [1] : []
        content {
      ...
      dynamic "custom_oidc_v2" {
        for_each = if try(auth_settings_v2.value.custom_oidc_v2, null) != null : [1] : []
        content {
      ...
      dynamic "facebook_v2" {
        for_each = if try(auth_settings_v2.value.facebook_v2, null) != null : [1] : []
        content {
      ...
      dynamic "github_v2" {
        for_each = if try(auth_settings_v2.value.github_v2, null) != null : [1] : []
        content {
      ...
      dynamic "google_v2" {
        for_each = if try(auth_settings_v2.value.google_v2, null) != null : [1] : []
        content {
      ...
      dynamic "microsoft_v2" {
        for_each = if try(auth_settings_v2.value.microsoft_v2, null) != null : [1] : []
        content {
      ...
      dynamic "twitter_v2" {
        for_each = if try(auth_settings_v2.value.twitter_v2, null) != null : [1] : []
        content {
  ...
  dynamic "backup" {
    for_each = if try(var.windows_function.backup, null) != null : [1] : []
    content {
      name                = backup.key
  ...
  dynamic "connection_string" {
    for_each = if try(var.windows_function.connection_string, null) != null : [1] : []
    content {
  ...
  dynamic "storage_account" {
    for_each = if try(var.windows_function.storage_account, null) != null : [1] : []
    content {
  ...
  dynamic "sticky_settings" {
    for_each = if try(var.windows_function.sticky_settings, null) != null : [1] : []
    content {
